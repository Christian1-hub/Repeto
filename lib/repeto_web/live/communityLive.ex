  ...
  defp assign_community_data(socket) do
    popular_communities = [
      %{
        ...
        btn_color: "border-indigo-200 dark:border-indigo-800 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-950/80",
        avatars: [
      ...
      %{
        ...
        btn_color: "border-emerald-200 dark:border-emerald-800 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950/80",
        avatars: [
      ...
      %{
        ...
        btn_color: "border-amber-200 dark:border-amber-800 text-amber-600 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-950/80",
        avatars: [
      ...
      %{
        ...
        btn_color: "border-blue-200 dark:border-blue-800 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/80",
        avatars: [
          "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=100",
          "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100",
          "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=100"
      ...
      %{
        ...
        btn_color: "border-rose-200 dark:border-rose-800 text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/80",
        avatars: [
          "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100",
          "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100",
          "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=100"
    ...
    my_communities = [
      %{name: "Mathématiques", time: "2 min", icon: "hero-calculator", color: "bg-indigo-50 dark:bg-indigo-950/50 text-indigo-600 dark:text-indigo-400"},
      %{name: "Prépa Bac 2025", time: "5 min", icon: "hero-academic-cap", color: "bg-amber-50 dark:bg-amber-950/50 text-amber-600 dark:text-amber-400"},
      %{name: "Physique-Chimie", time: "1 h", icon: "hero-beaker", color: "bg-emerald-50 dark:bg-emerald-950/50 text-emerald-600 dark:text-emerald-400"},
      %{name: "Informatique", time: "3 h", icon: "hero-code-bracket", color: "bg-blue-50 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400"},
      %{name: "Anglais", time: "1 j", icon: "hero-book-open", color: "bg-rose-50 dark:bg-rose-950/50 text-rose-600 dark:text-rose-400"}
    ]
    ...
    feed_posts = [
      %{
        ...
        community_bg: "bg-indigo-50 dark:bg-indigo-950/50 text-indigo-600 dark:text-indigo-400 border-indigo-100 dark:border-indigo-900/50",
        author: "M. Franck T.",
        role: "Répétiteur",
        verified: true,
        time: "2h",
      ...
      %{
        ...
        community_bg: "bg-amber-50 dark:bg-amber-950/50 text-amber-600 dark:text-amber-400 border-amber-100 dark:border-amber-900/50",
        author: "Aline D.",
      ...
      %{
        ...
        community_bg: "bg-emerald-50 dark:bg-emerald-950/50 text-emerald-600 dark:text-emerald-400 border-emerald-100 dark:border-emerald-900/50",
        author: "Dr. Alima S.",
      ...
      %{
        ...
        community_bg: "bg-teal-50 dark:bg-teal-950/50 text-teal-600 dark:text-teal-400 border-teal-100 dark:border-teal-900/50",
        author: "Marc L.",
      ...
      %{
        ...
        community_bg: "bg-blue-50 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400 border-blue-100 dark:border-blue-900/50",
        author: "Christian R.",
      ...
      %{
        ...
        community_bg: "bg-yellow-50 dark:bg-yellow-950/50 text-yellow-600 dark:text-yellow-400 border-yellow-100 dark:border-yellow-900/50",
        author: "Dr. Paul K.",
      ...
      %{
        ...
        community_bg: "bg-orange-50 dark:bg-orange-950/50 text-orange-600 dark:text-orange-400 border-orange-100 dark:border-orange-900/50",
        author: "Marc V.",
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_scope={assigns[:current_scope]} active_nav={@active_nav}>
      <div class="max-w-[1600px] mx-auto px-4 py-6">
        ...
        <!-- ================= HEADER COMMUNAUTÉS ================= -->
        <div class="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 mb-6 shadow-2xs flex flex-col md:flex-row items-start md:items-center justify-between gap-4 transition-colors">
          <div>
            <h1 class="font-extrabold text-2xl text-slate-900 dark:text-white tracking-tight">Communautés</h1>
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Rejoignez des communautés, échangez, apprenez et progressez ensemble.</p>
          </div>
          ...
          <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
            <div class="relative flex-1 md:w-72">
              ...
              <input
                ...
                class="w-full bg-slate-100/80 dark:bg-slate-800/80 border border-slate-200/80 dark:border-slate-700/80 rounded-2xl pl-10 pr-4 py-2.5 text-xs text-slate-700 dark:text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:bg-white dark:focus:bg-slate-800 transition-all"
              />
            </div>
            <button class="px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl text-xs font-bold flex items-center justify-center gap-2 shadow-sm transition-colors cursor-pointer shrink-0">
            ...
            <button
              ...
              class={[
                ...
                @active_filter == f.id
                  ...
                  || "bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 border-slate-200/80 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/60"
              ]}
            >
        ...
        <div class="grid grid-cols-12 gap-6 items-start">
          ...
          <div class="col-span-12 lg:col-span-9 space-y-6">
            ...
            <div class="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 shadow-2xs transition-colors">
              <div class="flex items-center justify-between mb-5">
                <h2 class="font-extrabold text-base text-slate-900 dark:text-white">Communautés populaires</h2>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4">
                <%= for comm <- @popular_communities do %>
                  <div class="bg-slate-50/60 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-800 rounded-2xl p-4 flex flex-col justify-between hover:border-indigo-300 dark:hover:border-indigo-700 transition-all group">
                    <div class="space-y-3">
                      ...
                      <div>
                        <h3 class="font-extrabold text-xs text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">{comm.name}</h3>
                        <p class="text-[10px] text-slate-400 dark:text-slate-500 font-medium">{comm.members}</p>
                      </div>
                      <p class="text-[11px] text-slate-600 dark:text-slate-300 leading-relaxed line-clamp-2">{comm.desc}</p>
                    </div>

                    <div class="pt-4 mt-4 border-t border-slate-200/60 dark:border-slate-800 space-y-3">
                      <div class="flex items-center justify-between">
                        <div class="flex -space-x-1.5 overflow-hidden">
                          <%= for avatar <- comm.avatars do %>
                            <img src={avatar} class="w-6 h-6 rounded-full object-cover border-2 border-white dark:border-slate-900" />
                          <% end %>
                        </div>
                        <span class="text-[10px] font-bold text-slate-400 dark:text-slate-500">{comm.extra_count}</span>
                      </div>
            ...
            <div class="flex items-center gap-2 border-b border-slate-200/80 dark:border-slate-800 pb-3 overflow-x-auto scrollbar-none">
              <% tabs = [
              ...
              <%= for t <- tabs do %>
                <button
                  ...
                  phx-value-tab={t.id}
                  class={[
                    "px-4 py-2 rounded-xl text-xs font-bold transition-colors cursor-pointer flex items-center gap-1.5 shrink-0",
                    @active_tab == t.id
            ...
            <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
              <%= for post <- @feed_posts do %>
                <div class="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-6 shadow-2xs flex flex-col justify-between space-y-4 transition-colors">
                  <div class="space-y-3">
                    <!-- En-tête du post -->
                    <div class="flex items-start justify-between">
                      <div class="flex items-center gap-3 min-w-0">
                        ...
                        <div class="min-w-0">
                          <h3 class="font-extrabold text-xs text-slate-900 dark:text-white truncate">{post.community}</h3>
                          <p class="text-[10px] text-slate-500 dark:text-slate-400 truncate">
                            Publié par {post.author} • {post.role}
                            <%= if post.verified do %>
                              <.icon name="hero-check-badge" class="w-3.5 h-3.5 text-indigo-600 dark:text-indigo-400 inline ml-0.5" />
                            <% end %>
                          </p>
                          <p class="text-[9px] text-slate-400 dark:text-slate-500">{post.time} • <.icon name="hero-globe-alt" class="w-3 h-3 inline" /></p>
                        </div>
                      </div>
                      <button class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 cursor-pointer shrink-0">
                    ...
                    <!-- Contenu textuel -->
                    <div>
                      <h4 class="font-extrabold text-xs text-slate-900 dark:text-white mb-1">{post.title}</h4>
                      <%= if post.text do %>
                        <p class="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">{post.text}</p>
                      <% end %>
                    </div>

                    <!-- Exercice de Maths -->
                    <%= if post.type == :math_exercise do %>
                      <div class="bg-slate-50/80 dark:bg-slate-800/50 border border-slate-200/80 dark:border-slate-700/60 rounded-2xl p-4 space-y-2 text-xs text-slate-800 dark:text-slate-200">
                        <p class="italic text-[11px]">Soit f la fonction affine définie par f(x) = 2x - 3.</p>
                        <ol class="list-decimal list-inside space-y-1 text-[11px] font-medium text-slate-700 dark:text-slate-300">
                    ...
                    <%= if post.type == :planning_table do %>
                      <div class="bg-slate-50/80 dark:bg-slate-800/50 border border-slate-200/80 dark:border-slate-700/60 rounded-2xl p-3 overflow-x-auto">
                        <table class="w-full text-left text-[10px] text-slate-700 dark:text-slate-300">
                          <thead>
                            <tr class="border-b border-slate-200 dark:border-slate-700 font-extrabold text-slate-900 dark:text-white">
                          ...
                          <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                            <tr>
                              ...
                              <td>Mécanique</td>
                              <td>Dissertation</td>
                              <td class="font-semibold text-indigo-600 dark:text-indigo-400">Bases solides</td>
                            </tr>
                            <tr>
                              ...
                              <td>Électricité</td>
                              <td>Commentaire</td>
                              <td class="font-semibold text-indigo-600 dark:text-indigo-400">Application</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                    ...
                    <%= if post.type == :image_card do %>
                      <div class="rounded-2xl overflow-hidden bg-slate-100 dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 p-1.5">
                  ...
                  <!-- Actions du post -->
                  <div class="pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between text-slate-500 dark:text-slate-400 text-xs">
                    <div class="flex items-center gap-4">
                      ...
                      <button class="flex items-center gap-1 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors cursor-pointer">
                    ...
                    <button class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 cursor-pointer">
          ...
          <div class="col-span-12 lg:col-span-3 space-y-6 lg:sticky lg:top-6">
            ...
            <!-- Mes communautés -->
            <div class="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-5 shadow-2xs space-y-4 transition-colors">
              <div class="flex items-center justify-between">
                <h3 class="font-extrabold text-xs text-slate-900 dark:text-white">Mes communautés</h3>
                <a href="#" class="text-[11px] font-bold text-indigo-600 dark:text-indigo-400 hover:underline">Voir tout</a>
              </div>

              <div class="space-y-3">
                <%= for comm <- @my_communities do %>
                  <div class="flex items-center justify-between group cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800/60 p-1.5 rounded-xl transition-colors">
                    <div class="flex items-center gap-3 min-w-0">
                      ...
                      <div class="min-w-0">
                        <p class="font-bold text-xs text-slate-900 dark:text-white truncate">{comm.name}</p>
                        <p class="text-[10px] text-slate-400 dark:text-slate-500">Dernière activité : {comm.time}</p>
                      </div>
                    </div>
            ...
            <div class="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-5 shadow-2xs space-y-4 transition-colors">
              <div class="flex items-center justify-between">
                <h3 class="font-extrabold text-xs text-slate-900 dark:text-white">Communautés suggérées</h3>
                <a href="#" class="text-[11px] font-bold text-indigo-600 dark:text-indigo-400 hover:underline">Voir tout</a>
              </div>
                ...
                <%= for sugg <- @suggested_communities do %>
                  <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2.5 min-w-0">
                      <div class="w-8 h-8 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 flex items-center justify-center shrink-0 border border-slate-200/60 dark:border-slate-700">
                        <.icon name={sugg.icon} class="w-4 h-4" />
                      </div>
                      <div class="min-w-0">
                        <p class="font-bold text-xs text-slate-900 dark:text-white truncate">{sugg.name}</p>
                        <p class="text-[10px] text-slate-400 dark:text-slate-500">{sugg.members}</p>
                      </div>
                    </div>
                    <button class="px-3 py-1.5 bg-indigo-50 dark:bg-indigo-950/60 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 text-indigo-600 dark:text-indigo-400 rounded-xl text-[11px] font-bold transition-colors cursor-pointer shrink-0">
                      Rejoindre
                    </button>
                  </div>
                <% end %>
            ...
            <div class="bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-5 shadow-2xs space-y-4 transition-colors">
              <div class="flex items-center justify-between">
                <h3 class="font-extrabold text-xs text-slate-900 dark:text-white">Événements à venir</h3>
                <a href="#" class="text-[11px] font-bold text-indigo-600 dark:text-indigo-400 hover:underline">Voir tout</a>
              </div>

              <div class="bg-slate-50/80 dark:bg-slate-800/50 border border-slate-200/80 dark:border-slate-700/60 rounded-2xl p-4 flex items-center gap-3.5">
                ...
                <div class="min-w-0 space-y-1">
                  <h4 class="font-extrabold text-xs text-slate-900 dark:text-white truncate">Webinaire : Réussir les maths au Bac 2025</h4>
                  <p class="text-[10px] text-slate-500 dark:text-slate-400">Avec M. Franck T.</p>
                  <p class="text-[10px] font-bold text-indigo-600 dark:text-indigo-400">Samedi à 16:00</p>
                </div>
              </div>
